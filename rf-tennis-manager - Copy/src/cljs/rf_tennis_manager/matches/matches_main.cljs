...
(defn schedule-form
  ...
  (fn []
    (let [team-info @(rf/subscribe [::subs/team-info])
          ...
          div-visible @(rf/subscribe [::subs/match-panel-visible "schedule"])]
...
(defn call-status
  ...
  (fn []
    (let [call-status @(rf/subscribe [::subs/matches_call_status])
          ...
          div-visible @(rf/subscribe [::subs/match-panel-visible "call-status"])
...
(defn availability-form
  ...
  (fn []
    (let [title "Update Availability"
          div-visible @(rf/subscribe [::subs/match-panel-visible "availability"])]
      [:div {:className (if div-visible "div-panel-show" "div-panel-hide")}
...
(defn availability-email-form
  ...
  (fn []
    (let [title "Send Availability Email"
          div-visible @(rf/subscribe [::subs/match-panel-visible "send-avail-email"])]
      [:div {:className (if div-visible "div-panel-show" "div-panel-hide")}
...
(defn lineup-email-form
  ...
  (fn []
    (let [title "Send Lineup Email"
          div-visible @(rf/subscribe [::subs/match-panel-visible "send-lineup-email"])]
      [:div {:className (if div-visible "div-panel-show" "div-panel-hide")}
...
(defn set-lineup-form
  ...
  []
  (fn []
    (let [div-visible @(rf/subscribe [::subs/match-panel-visible "set-lineup"])
